...
def generateLog(exceptiontype, traceback, variables):
    ...
    try:
        ...
        # Might not work on windows based on https://stackoverflow.com/questions/62798371/os-uname-function-not-working-in-windows
...
def sendErrorLogs():
    "parses through all error logs to find ones that havent been sent yet (In case of network going down etc)"
